            ...
            <FormItem className="flex flex-col gap-5">
              ...
              <FormControl>
                <Input 
                  ...
                  placeholder="name..."
                  {...field}
                  className="!mt-0 bg-color-7 border border-color-2 outline-none placeholder:text-white text-white focus-visible:ring-transparent focus-visible:ring-0 focus-visible:ring-offset-0"
                />
              </FormControl>
